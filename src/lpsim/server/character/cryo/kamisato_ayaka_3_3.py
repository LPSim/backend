...
from ...event import (
    ChooseCharacterEventArguments, GameStartEventArguments, 
...
from ..character_base import (
    ...
    PhysicalNormalAttackBase, PassiveSkillBase, CharacterBase, TalentBase
)
...
class KamisatoArtSenho(PassiveSkillBase):
    ...
    def infuse(self, match: Any) -> List[CreateObjectAction]:
        ...
        return [self.create_character_status(
...
register_class(
    KamisatoAyaka_3_3 | FrostflakeSekiNoTo_3_3 | KantenSenmyouBlessing_3_3
)
