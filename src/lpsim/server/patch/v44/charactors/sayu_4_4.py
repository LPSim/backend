...
from ....consts import (
    ...
    ElementType, ElementalReactionType, FactionType, IconType, 
...
class FuufuuWhirlwindKick(ElementalSkillBase):
    ...
    def get_actions(self, match: Match) -> List[Actions]:
        ...
        return [self.attack_opposite_active(
...
class Sayu_4_4(CharactorBase):
    ...
    max_charge: int = 2
    skills: List[
        PhysicalNormalAttackBase | YooHooArtFuuinDash | FuufuuWhirlwindKick 
...
desc: Dict[str, DescDictType] = {
    ...
    "SKILL_Sayu_NORMAL_ATTACK/Shuumatsuban Ninja Blade": {
        "names": {
            "en-US": "Shuumatsuban Ninja Blade",
            "zh-CN": "忍刀·终末番"
        },
        "descs": {
            "4.4": {
    ...
    "SKILL_Sayu_ELEMENTAL_BURST/Yoohoo Art: Mujina Flurry": {
        "names": {
            "en-US": "Yoohoo Art: Mujina Flurry",
            "zh-CN": "呜呼流·影貉缭乱"
        },
        "descs": {
            "4.4": {
    ...
    "TALENT_Sayu/Skiving: New and Improved": {
        "names": {
            "en-US": "Skiving: New and Improved",
            "zh-CN": "偷懒的新方法"
        },
        "descs": {
            "4.4": {
...
register_class(
    Sayu_4_4 | MujiMujiDaruma_4_4 | FuufuuWhirlwindKickStatus_4_4 
    | SkivingNewAndImproved_4_4, desc
)
