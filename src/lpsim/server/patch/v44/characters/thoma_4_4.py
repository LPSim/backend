...
from ....status.team_status.base import (
    ExtraAttackTeamStatus, ShieldTeamStatus, UsageTeamStatus
)
...
class Thoma_4_4(CharacterBase):
    ...
    max_charge: int = 2
    skills: List[
        PhysicalNormalAttackBase | BlazingBlessing | CrimsonOoyoroi
    ] = []
...
register_class(
    BlazingBarrier_4_4 | ScorchingOoyoroi_4_4 | ASubordinatesSkills_4_4
    | Thoma_4_4, desc
)
