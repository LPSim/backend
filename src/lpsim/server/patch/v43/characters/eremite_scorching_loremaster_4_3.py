...
class PyroScorpionGuardianStance_4_3(DefendCharacterStatus):
    name: Literal["Pyro Scorpion: Guardian Stance"] = "Pyro Scorpion: Guardian Stance"
...
class SpiritOfOmenPyroScorpion_4_3(AttackAndGenerateStatusSummonBase):
    name: Literal["Spirit of Omen: Pyro Scorpion"] = "Spirit of Omen: Pyro Scorpion"
    desc: Literal["", "talent"] = ""
    version: Literal["4.3"] = "4.3"
    usage: int = 2
    max_usage: int = 2
    ...
    def event_handler_USE_SKILL(
        ...
        if skill_position.player_idx != self.position.player_idx:
            ...
            return []
        character = match.player_tables[skill_position.player_idx].characters[
            skill_position.character_idx
        ]
        if character.name != "Eremite Scorching Loremaster":
...
class SpiritOfOmensAwakeningPyroScorpion(ElementalBurstBase):
    ...
    def get_actions(self, match: Match) -> List[Actions]:
        ...
        return super().get_actions(match) + [
            self.create_summon("Spirit of Omen: Pyro Scorpion", {"desc": summon_desc})
        ]
...
class SpiritOfOmensPower(PassiveSkillBase):
    ...
    def event_handler_RECEIVE_DAMAGE(
        ...
        if not event.final_damage.is_corresponding_character_receive_damage(
            character.position, match, ignore_piercing=False
        ):
...
desc: Dict[str, DescDictType] = {
    ...
    "CHARACTER_STATUS/Pyro Scorpion: Guardian Stance_talent": {
        "names": {"en-US": "Pyro Scorpion: Guardian Stance", "zh-CN": "炎之魔蝎·守势"},
        "descs": {
            "4.3": {
    ...
    "SKILL_Eremite Scorching Loremaster_PASSIVE/Spirit of Omen's Power": {
        "names": {"en-US": "Spirit of Omen's Power", "zh-CN": "厄灵之能"},
        "descs": {
            "4.3": {
    ...
    "TALENT_Eremite Scorching Loremaster/Scorpocalypse": {
        "names": {"en-US": "Scorpocalypse", "zh-CN": "魔蝎烈祸"},
        "descs": {
            "4.3": {
...
register_class(
    PyroScorpionGuardianStance_4_3
    | SpiritOfOmenPyroScorpion_4_3
    | Scorpocalypse_4_3
    | EremiteScorchingLoremaster_4_3,
    desc,
)
