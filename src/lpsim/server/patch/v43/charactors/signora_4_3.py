...
from ....status.charactor_status.base import (
    DefendCharactorStatus, ReviveCharactorStatus, RoundEndAttackCharactorStatus
)
...
from ....charactor.charactor_base import (
    ...
    ElementalNormalAttackBase, ElementalSkillBase, TalentBase
)
from .....utils.desc_registry import DescDictType


class PainForPainStatus_4_3(DefendCharactorStatus):
    ...
    def event_handler_MAKE_DAMAGE(
        ...
        our = match.player_tables[self.position.player_idx].charactors[
...
class IceSealedCrimsonWitchOfEmbers_4_3(ReviveCharactorStatus):
    name: Literal[
...
class SheerCold_4_3(RoundEndAttackCharactorStatus):
    name: Literal[
        'Sheer Cold',
        'Blazing Heat',
    ]
    ...
    def event_handler_CREATE_OBJECT(
        ...
        """
        When a charactor attachs two status, remove status in previous.
...
class PainForPain_4_3(TalentBase):
    ...
    version: Literal['4.3'] = '4.3'
    charactor_name: Literal['Signora'] = 'Signora'
    cost_label: int = (
...
class Signora_4_3(CharactorBase):
    ...
    max_charge: int = 2
    skills: List[
        SignoraNormalAttack | SignoraElementalSkill | CarmineChrysalis 
        | SignoraPyroBurst | MightOfDelusion
    ] = []
...
desc: Dict[str, DescDictType] = {
    ...
    "CHARACTOR/Signora_pyro": {
        "names": {
            "en-US": "Signora·Burned",
            "zh-CN": "「女士」·燃起来了"
        },
        "descs": {
            "4.3": {
    ...
    "SKILL_Signora_NORMAL_ATTACK/Frostblade Hailstorm": {
        "names": {
            "en-US": "Frostblade Hailstorm",
            "zh-CN": "霜锋霰舞"
        },
        "descs": {
            "4.3": {
                "en-US": "Deals 1 Cryo DMG.",
                "zh-CN": "造成1点冰元素伤害。"
            }
        }
    },
    ...
    "SKILL_Signora_ELEMENTAL_BURST/Pyro Burst": {
        ...
        "descs": {
            "4.3": {
                "en-US": "Deals 6 Pyro DMG.",
                "zh-CN": "造成6点火元素伤害。"
            }
        }
    },
    "CHARACTOR_STATUS/Ice-Sealed Crimson Witch of Embers": {
        "names": {
    ...
    "CHARACTOR_STATUS/Pain for Pain": {
        "names": {
            "en-US": "Pain for Pain",
            "zh-CN": "苦痛奉还"
        },
...
register_class(
    IceSealedCrimsonWitchOfEmbers_4_3 | SheerCold_4_3 | Signora_4_3 
    | PainForPain_4_3 | PainForPainStatus_4_3, desc
)
