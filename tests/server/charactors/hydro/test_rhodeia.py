...
def test_rhodeia():
    cmd_records = [
        [
            ...
            "TEST 2 p1 summon 2 usage",
            "skill 2 0 1 2 3 4",
            "TEST 2 p0 summon 3 usage 3 1 2",
            "TEST 2 p1 summon 3 usage 2 2 2",
            "TEST 1 10 87 10 10 89 10",
            "card 0 0 0 1 2 3",
            "TEST 2 p0 summon 3 usage 4 2 2",
            "TEST 2 p1 summon 3 usage 3 3 2",
            "skill 0 0 1 2",
            "end",
            "TEST 1 10 76 10 10 80 10",
            "TEST 2 p0 summon 3 usage",
            "TEST 2 p1 summon 2 usage",
            "sw_char 0 0",
            "skill 1 0 1 2",
            ...
            "skill 1 0 1 2",
            "skill 3 0 1 2",
            "TEST 1 8 70 10 9 68 9",
            "TEST 2 p0 summon 4 usage 4 3 3 3",
            "end",
            "end",
            "end",
            "end",
        ...
        [
            ...
            "skill 3 0 1 2",
            "end",
            "TEST 2 p0 summon 4 usage 3 2 1 2",
            "TEST 1 8 69 10 8 63 8",
            "end",
            "end",
            "end",
            "end",
