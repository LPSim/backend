...
def test_trigger_order_in_charactor():
    match, agent_0, agent_1 = read_from_log_json(
        os.path.join(os.path.dirname(__file__), 'jsons', 'test_trigger_order_in_charactor.json')  # noqa: E501
    )
...
if __name__ == '__main__':
    test_trigger_order_in_charactor()
